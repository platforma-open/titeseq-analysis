...
from constants import FitParams, DEFAULT_PARAMS
...
def test_classification_with_non_default_thresholds():
    strict = FitParams(
        r2_threshold_good=0.95, r2_threshold_failed=0.7, n_min=0.8, n_max=3.0
    )
...
@pytest.mark.parametrize("precomputed", [
    "insufficient_reads", "insufficient_points", "non_monotonic_signal",
])
